...
public class SpaceProxyImplGetBatchForIteratorAction extends GetBatchForIteratorProxyAction<SpaceProxyImpl> {
    public SpaceIteratorBatchResult getNextBatch(SpaceProxyImpl spaceProxy, GetBatchForIteratorProxyActionInfo actionInfo)
        ...
        try {
            final GetBatchForIteratorSpaceOperationRequest request = new GetBatchForIteratorSpaceOperationRequest(actionInfo.queryPacket, actionInfo.modifiers, actionInfo.maxResults, actionInfo.getQuery(), actionInfo.uuid, actionInfo.firstTime);
