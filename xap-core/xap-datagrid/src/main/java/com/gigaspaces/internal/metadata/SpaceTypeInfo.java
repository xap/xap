...
public class SpaceTypeInfo implements Externalizable {
    ...
    private Class<? extends ClassBinaryStorageAdapter> _spaceClassStorageAdapter = Boolean.parseBoolean(System.getProperty("com.gs.disable.hybrid", "false")) ? null : DirectClassBinaryStorageAdapter.class;
