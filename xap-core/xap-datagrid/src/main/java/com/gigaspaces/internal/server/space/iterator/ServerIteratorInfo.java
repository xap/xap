...
public class ServerIteratorInfo {
    ...
    private volatile ITemplateHolder templateHolder;
...
//        this.status = ServerIteratorStatus.ACTIVE;
    ...
    public boolean isActive(){
        return status != null && status.equals(ServerIteratorStatus.ACTIVE);
    }

    public boolean isExpired(){
        return !isActive() && status.equals(ServerIteratorStatus.EXPIRED);
    }
