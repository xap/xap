...
public class CloseIteratorSpaceRequestInfo extends AbstractSpaceRequestInfo {
     ...
     */
    public CloseIteratorSpaceRequestInfo() {
    }

    public CloseIteratorSpaceRequestInfo(UUID iteratorId) {
