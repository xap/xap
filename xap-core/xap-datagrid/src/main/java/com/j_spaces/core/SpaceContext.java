...
public class SpaceContext implements Externalizable {
    ...
    public SpaceContext(boolean fromGateway, int chunksMapGeneration, boolean nonClustered) {
    ...
    public SpaceContext createCopy(SecurityContext newSecurityContext) {
        SpaceContext newContext = new SpaceContext(fromGateway, chunksMapGeneration, nonClustered);
    ...
    public boolean isNonClustered(){ return nonClustered;}
    ...
    private static final short FLAG_NON_CLUSTERED = 1 << 3;
    ...
    private void readExternalV15_8_0(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        this.nonClustered = (flags & FLAG_NON_CLUSTERED) != 0;
