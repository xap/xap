...
public class SystemProperties extends CommonSystemProperties {
    ...
    public static final String ADMIN_DEFAULT_UNDEPLOY_FORCE = "com.gs.admin.default-undeploy-force";
    public static final String ADMIN_SAFE_UNDEPLOY_ENABLED = "com.gs.admin.safe-undeploy-enabled";
    public static final String ADMIN_SAFE_UNDEPLOY_TIMEOUT = "com.gs.admin.safe-undeploy-timeout";
    public static final long ADMIN_SAFE_UNDEPLOY_TIMEOUT_DEFAULT = 60000;
