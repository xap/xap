...
public class XapManagerConfig {
    ...
    private static final String DEFAULT_REST = CommonSystemParamOrEnvVariable.getStringFromEnv(CommonSystemProperties.MANAGER_REST_PORT, "MANAGER_REST_PORT", "8090");
