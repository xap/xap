...
//TODO move to common lucene module
public class LuceneSpatialTypeIndex implements Closeable {
    ...
    public LuceneSpatialTypeIndex(LuceneTextSearchConfiguration luceneConfig, String namespace, SpaceTypeDescriptor typeDescriptor) throws IOException {
