...
public class Statement implements java.sql.Statement {
    private final com.gigaspaces.sql.aggregatornode.netty.jdbc.Connection connection;

    public Statement(com.gigaspaces.sql.aggregatornode.netty.jdbc.Connection connection) {
