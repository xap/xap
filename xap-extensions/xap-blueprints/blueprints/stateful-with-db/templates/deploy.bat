...
call ..\gs pu deploy --properties={{project.artifactId}}-values.yaml --zones={{project.artifactId}}-mirror -p ha=ha=%SPACE_HA% {{project.artifactId}}-mirror target\{{project.artifactId}}-mirror-{{project.version}}.jar
