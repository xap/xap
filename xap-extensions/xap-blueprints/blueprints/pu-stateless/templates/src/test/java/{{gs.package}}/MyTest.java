...
public class MyTest {
    ...
    @Before
    public void before() {
        System.out.println("Starting embedded space {{spaceName}}...");
        spaceConfigurer = new EmbeddedSpaceConfigurer("{{spaceName}}");
    ...
    public void after() {
        appContext.close();
        System.out.println("Closing embedded space {{spaceName}}...");
    ...
    public void testService() throws IOException {
        ...
        Assert.assertEquals("{{spaceName}}", gigaSpace.getSpaceName());
