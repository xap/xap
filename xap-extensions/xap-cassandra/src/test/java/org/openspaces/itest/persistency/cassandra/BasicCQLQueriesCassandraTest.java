...
public class BasicCQLQueriesCassandraTest extends AbstractCassandraTest {
    ...
    private SpaceTypeDescriptor createMockSpaceTypeDescriptor() {
        return new SpaceTypeDescriptorBuilder(TEST_CF)
                ...
                .addPathIndex(LONG_COL, SpaceIndexType.EQUAL)
                .addPathIndex(STRING_COL, SpaceIndexType.EQUAL)
                .addPathIndex(BIGINT_COL, SpaceIndexType.EQUAL)
                .addPathIndex(DYNAMIC_COL_1, SpaceIndexType.EQUAL)
                .addPathIndex(DYNAMIC_COL_2, SpaceIndexType.EQUAL)
                .addPathIndex(DYNAMIC_COL_3, SpaceIndexType.EQUAL)
                .addPathIndex(DYNAMIC_COL_4, SpaceIndexType.EQUAL)
                .addPathIndex(DYNAMIC_COL_5, SpaceIndexType.EQUAL)
                .addPathIndex(DYNAMIC_COL_6, SpaceIndexType.EQUAL)
                .addPathIndex(DYNAMIC_COL_7, SpaceIndexType.EQUAL)
                .addPathIndex(DYNAMIC_COL_8, SpaceIndexType.EQUAL)
                .addPathIndex(DYNAMIC_COL_9_NAME, SpaceIndexType.EQUAL)
                .addPathIndex(DYNAMIC_COL_9_AGE, SpaceIndexType.EQUAL)
                .idProperty(KEY_NAME)
                .create();
    }
