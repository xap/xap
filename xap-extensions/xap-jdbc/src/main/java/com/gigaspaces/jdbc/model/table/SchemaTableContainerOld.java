...
//
//public class SchemaTableContainerOld extends TableContainer {
//    private final GSSchemaTable table;
//    private final IJSpace space;
//    private TableContainer joinedTable;
//    private final List<ConcreteColumn> visibleColumns = new ArrayList<>();
//    private final List<ConcreteColumn> tableColumns;
//    private TempTableQTP queryTemplatePacket;
//
//    public SchemaTableContainerOld(GSSchemaTable table, IJSpace space) {
//        this.table = table;
//        this.tableColumns = Arrays.stream(table.getSchemas()).map(x -> new ConcreteColumn(x.getPropertyName(), x.getSqlTypeName().getDeclaringClass(), null, true, this, -1)).collect(Collectors.toList());
//        this.space = space;
//    }
//
//    @Override
//    public QueryResult executeRead(QueryExecutionConfig config) throws SQLException {
//        List<ConcreteColumn> queryColumns = getVisibleColumns();
//        QueryResult queryResult = table.execute(this, space, tableColumns);
//        if (queryTemplatePacket != null) {
//            queryResult.filter(x -> queryTemplatePacket.eval(x));
//        }
//        queryResult = new TempQueryResult(visibleColumns, queryResult);
//        return queryResult;
//    }
//
//    @Override
...
//
//    @Override
//    public List<ConcreteColumn> getVisibleColumns() {
